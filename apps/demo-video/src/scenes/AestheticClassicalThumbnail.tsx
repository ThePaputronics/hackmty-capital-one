...
export const AestheticClassicalThumbnail: React.FC = () => {
  return (
    <div
      style={{
        width: 1920,
    ...
    >
      ...
      <div
        style={{
          ...
          height: 700,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(182, 130, 53, 0.08) 0%, transparent 70%)',
          pointerEvents: 'none',
        }}
      />
      <div
        style={{
          ...
          height: 650,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(140, 47, 57, 0.07) 0%, transparent 70%)',
          pointerEvents: 'none',
        }}
      />
      ...
      >
        ...
        <div
          style={{
            ...
            boxShadow: '0 1px 2px rgba(45, 43, 43, 0.05)',
          }}
        >
          <span
            style={{
              ...
              boxShadow: '0 0 0 3px rgba(140, 47, 57, 0.15)',
            }}
          />
          <span
            style={{
      ...
      {/* Hero Body Layout: Editorial Left + Floating Phone Right */}
      <div
        style={{
          display: 'grid',
      ...
      >
        {/* Left Column: Bold Editorial Typography + Metrics Strip */}
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', maxWidth: '780px' }}>
            {/* Metric 1 */}
            <div
              style={{
                backgroundColor: '#ffffff',
            ...
            >
              ...
              <div style={{ fontSize: '12px', color: 'rgba(32, 31, 29, 0.65)', marginTop: '6px' }}>
        ...
        {/* Right Column: Hero Floating Classical Phone Mockup */}
        <div
          style={{
            display: 'flex',
        ...
        >
          {/* Classical Frame Container with Shadow */}
          <div
            style={{
              width: '370px',
              ...
              borderRadius: '28px',
              padding: '12px',
              boxShadow: '0 24px 60px rgba(45, 41, 41, 0.18), 0 4px 12px rgba(45, 41, 41, 0.08)',
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ color: '#b68235' }}>SPEI</span>
              </div>
              ...
              <div style={{ padding: '22px 20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                <div>
                  ...
                  >
                    $12,450.00{' '}
                    <span style={{ fontSize: '15px', fontFamily: '"Lora", serif', color: 'rgba(32, 31, 29, 0.5)' }}>
                      MXN
                    </span>
                  </div>
                </div>
                ...
                >
                  ...
                  <div style={{ fontFamily: 'monospace', fontSize: '13px', marginTop: '2px', fontWeight: 600 }}>
                    646180157088992112
                  </div>
                  <div style={{ fontSize: '11px', color: '#7d5411', marginTop: '4px' }}>
                ...
                >
                  ...
                  <div style={{ fontSize: '12.5px', lineHeight: 1.45, color: '#444141' }}>
